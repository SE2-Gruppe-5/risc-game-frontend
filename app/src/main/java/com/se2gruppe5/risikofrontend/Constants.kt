...
class Constants {
    companion object {
        ...
        val ASSIGN_TERRITORIES_URL: String = dotenv["ASSIGN_TERRITORIES_URL"] ?: "/game/{id}/assign-territories"
        val DISTRIBUTE_TROOPS_URL: String = dotenv["DISTRIBUTE_TROOPS_URL"] ?: "/game/{id}/distribute-troops"
    }
}